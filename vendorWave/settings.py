"""
Django settings for vendorWave project.
...
SECRET_KEY = config("SECRET_KEY",'django-insecure-1o_uld=2pvobot)2v48@=1p0q+-fdqwnmmmjst^eih2lu$orr1')
...
WSGI_APPLICATION = 'vendorWave.wsgi.application'
